...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="font-family:CaviarDreams_Bold;color:#4c4743;">Search For Groom Divorcee</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
       			 <div class="col-sm-12 col-md-8">
           			 <div class="form-group">
            				<form method="post" action="search_groom_divorce.php">
           		...
           		<div class="col-lg-12">
					<div class="table-responsive">
                        ...
                        <?php
							...
							$query=mysqli_query($conn,"select * from matrimonialall where  gender='Groom' and marriageType='divorcee' and is_del='no' and ( mobile_no1 LIKE '%$search%' or mobile_no2 LIKE '%$search%' or city LIKE '%$search%' or payment LIKE '%$search%') order by first_name LIMIT $start, $limit  ");
						?>
							<thead style="background-color:#20282b;color:#fff;">
								<tr style="font-size:14px;">
									...
									<th style="text-align:center;font-weight:100;">Edit Divorcee Information</th>
							...
							<tr style="font-size:14px;">
								...
								<td style="text-align:center;font-weight:100;padding-left:10px; background-color:#fff;font-family: CaviarDreams;"><?php echo "<a href=edit_matrimony_divorce.php?unique_id=".$query2['unique_id']." style='color: #fff;'><input type=submit name=Edit value=Edit class=btn btn-warning style='background-color:#00a0e3;height: 25px;padding-top: 1px;margin-top: 2px;'></a>";?></td>
								<td style="text-align:center;font-weight:100;padding-left:10px; background-color:#dfe6e8;font-family: CaviarDreams;"><?php echo "<a href=edit_professional_info.php?unique_id=".$query2['unique_id']." style='color: #fff;'><input type=submit name=Edit value=Edit class=btn btn-warning style='background-color:#00a0e3;height: 25px;padding-top: 1px;margin-top: 2px;'></a>";?></td>
								<td style="text-align:center;font-weight:100;padding-left:10px; background-color:#fff;font-family: CaviarDreams;"><?php echo "<a href=show_gallary.php?unique_id=".$query2['unique_id']." style='color: #fff;'><input type=submit name=Edit value=Edit class=btn btn-warning style='background-color:#00a0e3;height: 25px;padding-top: 1px;margin-top: 2px;'></a>";?></td>
								<td style="text-align:center;font-weight:100;padding-left:10px; background-color:#dfe6e8;font-family: CaviarDreams;"><?php echo "<a href=delete_matrimony.php?unique_id=".$query2['unique_id']."&type=".str_replace(' ', '_',$query2['marriageType'])."&gender=".$query2['gender']." style='color: #fff;height: 25px;padding-top: 1px;margin-top: 2px;'><input type=submit name=Delete value=Delete class=btn btn-warning style='background-color:#00a0e3;height: 25px;padding-top: 1px; margin-top: 2px;'></a>";?></td>
								<td style="text-align:center;font-weight:100;padding-left:10px; background-color:#fff;">
								<?php
						...
						<?php
							$search = $_GET['search'];
							$rows=mysqli_num_rows(mysqli_query($conn,"select * from matrimonialall where  gender='Groom' and marriageType='divorcee' and is_del='no' and ( mobile_no1 LIKE '%$search%' or mobile_no2 LIKE '%$search%' or city LIKE '%$search%' or payment LIKE '%$search%') order by first_name"));
							$total=ceil($rows/$limit);
							
							if($id>1)
							{
								//Go to previous page to show previous 10 items. If its in page 1 then it is inactive
								echo "<a href='?search=".$_GET['search']."&id=".($id-1)."' class='btn btn-info'>PREV</a>";
								echo "&nbsp;";
							}
							for($i=1;$i<=$total;$i++)
							{
								...
								{  
									echo "<a class='btn' href='?search=".$_GET['search']."&id=".$i."'>".$i."&nbsp;</a>"; 
							...
							if($id!=$total)
							{
								...
								echo "&nbsp;";
								echo "<a href='?search=".$_GET['search']."&id=".($id+1)."' class='btn btn-info'>NEXT</a>";
							}
