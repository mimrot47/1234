                   ...
                   <div class="row" style="padding-left:20px;">
						<div class="col-lg-10">
                    		<div class="panel panel-default">
                        		<div class="panel-heading"><h2 style="font-size:20px; margin-top: 7px; text-align:center;font-family: CaviarDreams;"> <b>Change Password </b></h2></div>
                       			 <div class="panel-body">
                         
                            		<div class="row">
                           				<form action="change_password_insert.php" method="post" enctype="multipart/form-data" >
										
										<div class="form-horizontal form-bordered" style="font-family:CenturyGothict;">
										
										<div class="form-group">
																						
										<label class="col-md-4 control-label" style="padding-left:100px;text-align: left;">Add New Password</label> <div class="col-md-7">
