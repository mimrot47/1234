...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="font-family:CaviarDreams_Bold;color:#4c4743;">Search For Groom Widower</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
             <div class="row">
       			 <div class="col-sm-12 col-md-8">
           			 <div class="form-group">
            				<form method="post" action="search_groom_widow.php">
                 	...
                 	<div class="table-responsive">
						<table class="table table-condensed mb-none" border="0" cellpadding="0" cellspacing="0" style="font-family:futura_medium_bt;">
							 <?php
								...
								$query=mysqli_query($conn,"select * from matrimonialall where gender='Groom' and marriageType='widower' and is_del='no' and ( mobile_no1 LIKE '%$search%' or mobile_no2 LIKE '%$search%' or city LIKE '%$search%' or payment LIKE '%$search%') order by first_name LIMIT $start, $limit  ");
							?>
							<thead style="background-color:#20282b;color:#fff;">
								<tr style="font-size:14px;">
									...
									<th style="text-align:center;font-weight:100;">Edit Widower Information</th>
							...
							<tr style="font-size:14px;">
								...
								<td style="text-align:center;font-weight:100;padding-left:10px; background-color:#fff;font-family: CaviarDreams;"><?php echo "<a href=edit_matrimony_widow.php?unique_id=".$query2['unique_id']." style='color: #fff;'><input type=submit name=Edit value=Edit class=btn btn-warning style='background-color:#00a0e3;height: 25px;padding-top: 1px;margin-top: 2px;'></a>";?></td>
						...
						<?php
							$rows=mysqli_num_rows(mysqli_query($conn,"select * from matrimonialall where  gender='Groom' and marriageType='widower' and is_del='no' and ( mobile_no1 LIKE '%$search%' or mobile_no2 LIKE '%$search%' or city LIKE '%$search%' or payment LIKE '%$search%') order by first_name "));
