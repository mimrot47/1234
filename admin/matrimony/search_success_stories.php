...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="font-family:CaviarDreams_Bold;color:#4c4743;">Search Success Stories</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                 	...
                 	<div class="table-responsive">                    
						<table class="table table-condensed mb-none" border="0" cellpadding="0" cellspacing="0" style="font-family:futura_medium_bt;">
							<?php
								...
								$show1=mysqli_query($conn,"select * from success_stories where keyword LIKE '%$keyword%' order by bride_name LIMIT $start, $limit");
           					?>
							...
							?>
								<tr style="font-size:14px;">
									...
									<td style="text-align:left;font-weight:100;padding-left:10px; background-color:#dfe6e8;"><?php $photo=$row['photo'];echo  '<img src="matrimony_success_img/'. $photo.'" height="50" width="50">';?></td>
						...
						<?php
							$rows=mysqli_num_rows(mysqli_query($conn,"select * from success_stories where keyword LIKE '%$keyword%' order by bride_name"));
