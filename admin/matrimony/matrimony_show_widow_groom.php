    ...
    <div id="wrapper">
       ...
       <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;background-color: #f26844;height:90px;">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                     <h1 class="page-header" style="font-family:CaviarDreams_Bold;color:#4c4743;">Groom Widower</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                ...
                <div class="col-lg-12">
                   <div class="table-responsive">
						...
						<?php
							...
							$query=mysqli_query($conn,"select * from matrimonialall where gender='Groom' and is_del='no' and marriageType='widower' order by first_name LIMIT $start, $limit ");
						?>
						...
						<?php
							echo'<div id="content">';
							$rows=mysqli_num_rows(mysqli_query($conn,"select * from matrimonialall where gender='Groom' and is_del='no' and marriageType='widower' order by first_name"));
