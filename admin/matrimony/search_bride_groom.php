...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="font-family:CaviarDreams_Bold;color:#4c4743;">Search For Bride</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
           		...
           		<div class="col-lg-12">
					<div class="table-responsive">
						...
						<?php
							...
							$select = "select * from matrimonialall where  gender='Bride' and is_del='no' and marriageType='Never married' and ( mobile_no1 LIKE '%$search%' or mobile_no2 LIKE '%$search%' or city LIKE '%$search%' or payment LIKE '%$search%') order by first_name LIMIT $start, $limit  ";
						...
						<thead style="background-color:#20282b;color:#fff;">
                      	...
                      	<div id="content">
					    <?php
						$rows=mysqli_num_rows(mysqli_query($conn,"select * from matrimonialall where  gender='Bride' and is_del='no' and marriageType='Never married' and ( mobile_no1 LIKE '%$search%' or mobile_no2 LIKE '%$search%' or city LIKE '%$search%' or payment LIKE '%$search%') order by first_name"));
