...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="font-family:CaviarDreams_Bold;color:#4c4743;">Search For Bride Divorcee</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
       			 <div class="col-sm-12 col-md-8">
           			 <div class="form-group">
            				<form method="post" action="search_bride_divorce.php">
            	...
            	<div class="col-lg-12">
                	<div class="table-responsive">
                        ...
                        <?php
							...
							$query=mysqli_query($conn,"select * from matrimonialall where  gender='Bride' and marriageType='divorcee' and is_del='no' and ( mobile_no1 LIKE '%$search%' or mobile_no2 LIKE '%$search%' or city LIKE '%$search%' or payment LIKE '%$search%') order by first_name LIMIT $start, $limit  ");
						?>
						...
						<?php	
							echo'<div id="content">';				
							$rows=mysqli_num_rows(mysqli_query($conn,"select * from matrimonialall where  gender='Bride' and marriageType='divorcee' and is_del='no' and ( mobile_no1 LIKE '%$search%' or mobile_no2 LIKE '%$search%' or city LIKE '%$search%' or payment LIKE '%$search%') order by first_name"));
