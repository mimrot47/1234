              ...
              $(document).ready(function(){
                    $("#button").click(function(){
						 var button=$("#button").val();
						  ...
						  var marital_satus_of_siblings=$("#marital_satus_of_siblings").val();
				...
				if(no_of_siblings==null || no_of_siblings=="")
				{    
					  alert("Enter your Number of Siblings ");
					  return false;
				}
				if(marital_satus_of_siblings==null || marital_satus_of_siblings=="")
				{    
					  alert("Enter your Marital Satus of Siblings ");
					  return false;
				}
                ...
                <form class="form-horizontal" name="form1" action="reg_insert.php" method="post"> 
                            ...
                            <div class="col-sm-12 _heading">
                             ...
                             Personal Information</h4>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="first_name" name="first_name" type="text" onkeypress="return onlyAlphabets(event,this);" class="form-control input-md" >
                                    </div>
                                </div>
                                <!-- Text input-->
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="middle_name" name="middle_name" type="text" onkeypress="return onlyAlphabets(event,this);" class="form-control input-md">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="last_name">Last Name </label>  
                                    <div class="col-sm-8">
                                        <input id="last_name" name="last_name" type="text" onkeypress="return onlyAlphabets(event,this);" class="form-control input-md" >
                                    </div>
                                </div>
                                <div class="form-group">
                   ...
                   ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="mobile_no1" name="mobile_no1" type="text" maxlength="12" class="form-control input-md" onkeypress="return onlyNos(event,this);"   >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="mobile_no2">Mobile Number 2</label>
                                    <div class="col-sm-8">
                                        <input id="mobile_no2" name="mobile_no2" type="text" maxlength="12" onkeypress="return onlyNos(event,this);"  class="form-control input-md" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="birth_date" placeholder="DD/MM/YYYY" name="DATEOFBIRTH" class="form-control input-md" onchange="countAge(this.form, this);" onkeypress="return isNumber(event)" > 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="birth_time">Time of Birth</label>  
                                    <div class="col-sm-8">
                                        <input id="birth_time" name="birth_time" type="time" onkeypress="return isNumber(event)"  class="form-control input-md"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="birth_city" name="birth_city" type="text"  class="form-control input-md" onkeypress="return onlyAlphabets(event,this);" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="birth_district">Birth Place District</label>  
                                    <div class="col-sm-8">
                                        <input id="birth_district" name="birth_district" type="text"  class="form-control input-md" onkeypress="return onlyAlphabets(event,this);">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-sm-12 _heading">
                             ...
                             <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">                     
                                        <textarea class="form-control" id="acceptation" name="acceptation" onkeypress="return onlyAlphabets(event,this);" rows="2"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="describe_yourself">Describe Yourself </label>
                                    <div class="col-md-8">                     
                                        <textarea class="form-control" id="describe_yourself" name="describe_yourself" onkeypress="return onlyAlphabets(event,this);" rows="2"></textarea>
                                    </div>
                                </div> 
                            ...
                            <div class="col-sm-12 _heading">
                               ...
                               Professional Information</h4>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="working_post" name="working_post" type="text" onkeypress="return onlyAlphabets(event,this);" class="form-control input-md"> 
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 _heading">
                               ...
                               Family Information</h4>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="occupation" name="occupation_father" type="text" onkeypress="return onlyAlphabets(event,this);" class="form-control input-md">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">                     
                                        <input type="text" class="form-control" id="occupation_mother" onkeypress="return onlyAlphabets(event,this);" name="occupation_mother" ></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="marital_satus_of_siblings">Marital Satus of Brother</label>  
                                    <div class="col-sm-8">
                                       
                                        	 <select name="marital_satus_of_brother"   class="form-control input-md" >
                                        	<option> </option>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="marital_satus_of_siblings">Marital Satus of sister</label>  
                                    <div class="col-sm-8">
                        ...
                        <div class="col-sm-12" id="id05">
                         <div class="col-sm-12 _heading">
                            ...
                            <div class=" col-sm-12" style="text-align:center">
                                <input type="submit" value="Sign Up" name="button" id="button" onclick="allLetter(document.form1.text1)" class="btn btn-primary  ">
                                <div id="w8"></div>
                                <div id="info" ></div>
                            </div>
                        </div>
